...
export default function Page() {
  return (
    <div className="d-flex flex-column justify-cc mt-3">
      ...
      <DescWrapper>
        데이터 분석 공부 중 SW개발에 흥미가 생기게 되어 진로 변경하였습니다.
        &nbsp;
        <b className="tc-yellow">JavaScript</b> 기본기를 다지면서 개발 트렌드를
        살펴보았고 트렌드의 변화로 인해 개발 과정의 많은 부분이 프론트엔드로
        넘어가는 것을 보았습니다. 코드 작성 후 결과물의 즉각적인 변화를 확인할
        수 있는 점이 흥미에도 맞다고 생각하여 현재는&nbsp;
        ...
        <b className="tc-blue">TypeScript</b>,&nbsp;
      ...
      <DescWrapper>
        ...
        산다는 말이 있습니다. &nbsp;
        <b className="tc-yellow">JavaScript,</b>&nbsp;
        <b className="tc-blue">TypeScript,</b>&nbsp;
        <b style={{ color: "cyan" }}>
          <i className="ri-reactjs-fill"></i>React&nbsp;18
        </b>
        &nbsp; 등 언어, 라이브러리 및 프레임워크를 공부하면서 적어두어야할
