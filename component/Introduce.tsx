    ...
    <section className={styles.container}>
      <div className={styles.greeting}>
        ...
        <div className={styles.desc}>
          ...
          시작하였고 &nbsp;
          <b style={{ color: 'yellow' }}>JavaScript</b> 기본기를 마치고
          현재는&nbsp;
          ...
          환경 내에서 API를 바로 테스트 할 수 있게 swagger를 사용했습니다. 제가
        ...
        <div className={styles.desc}>
          ...
          산다는 말이 있습니다.&nbsp;
          <b style={{ color: 'yellow' }}>JavaScript,</b>&nbsp;
          <b style={{ color: '#4b56d2' }}>TypeScript,</b>&nbsp;
          <b style={{ color: 'cyan' }}>
            <i className='ri-reactjs-fill'></i>React&nbsp;18
          </b>
          &nbsp; 등 언어, 라이브러리, 프레임워크를 공부하면서 적어두어야할
          내용은 수시로 블로그에 기록하고 있습니다. 블로그의 글을 읽는 것만으로
          도움이 되도록 열심히 적어보겠습니다.
        </div>
      </div>
